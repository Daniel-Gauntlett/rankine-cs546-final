...
try
{
    ...
    event1 = await events.createEvent("General GBM", "Our general GBM, where we discuss a variety a topics each week!",
        ...
        "dgauntlett", [], ["dgauntlett"], "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyOBFRML09gNsjdrpsbp0TxbSaQ95AOy-fIw&s"
    );
    console.log(event1);
    event2 = await events.createEvent("Party For PHI", "Join the Party at our Frat House! Free Food Provided",
        ...
        "dbarrand", [], ["dgauntlett"], "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyOBFRML09gNsjdrpsbp0TxbSaQ95AOy-fIw&s"
    );
    console.log(event2);
    event3 = await events.createEvent("Boba And Paint!", "Come relax and paint while sipping on boba provided by Kung Fu Tea", 
        new Date("September 10, 2024 20:00:00 EST").toJSON(), new Date("September 10, 2024 21:00:00 EST").toJSON(),false,null,false,"6744b2de7d63b9e12950d9d3",1,"jbrown",[],[],"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyOBFRML09gNsjdrpsbp0TxbSaQ95AOy-fIw&s");
    console.log(event3);
